              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    _LabeledField(controller: startController, label: "Start Code:"),
                    _LabeledField(controller: endController, label: "End Code"),
                    // NEW: cities
                    _LabeledField(controller: startCityController, label: "Start Point"),
                    _LabeledField(controller: endCityController, label: "End Point"),
                    SizedBox(height: 10.h),
                    SizedBox(
